    ...
    <section className="relative bg-gradient-to-br from-zinc-900 to-black py-14 sm:py-20">
      ...
      <Container>
        <div className="relative z-10 flex flex-col items-center text-center">
          ...
          <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold mb-4 text-zinc-50 leading-tight">Yapay Zeka Sanatı Nasıl Dönüştürüyor?</h1>
          <p className="text-base sm:text-lg text-zinc-50 mb-6 max-w-xl sm:max-w-2xl mx-auto">Dall-E 3 ve Midjourney gibi araçların yaratıcı endüstriler üzerindeki devrimsel etkisini inceliyoruz.</p>

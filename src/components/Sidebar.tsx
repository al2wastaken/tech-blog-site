    ...
    <aside className="w-full md:w-80 flex-shrink-0 md:pl-0 pl-0 sm:pl-0">
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-lg shadow p-4 mb-4">
        <form className="flex flex-row gap-2">
          <input type="text" placeholder="Site içi ara..." className="flex-1 min-w-0 h-10 px-4 rounded border border-zinc-300 dark:border-zinc-700 focus:outline-none" />
      ...
      {/* Categories Widget */}
      <div className="bg-white dark:bg-zinc-900 rounded-lg shadow p-4 sm:p-6 mb-4 sm:mb-6">
